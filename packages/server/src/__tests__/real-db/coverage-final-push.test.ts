...
beforeAll(async () => {
  try {
    db = knexLib({ client: "mysql2", connection: { host: "localhost", port: 3306, user: "empcloud", password: process.env.DB_PASSWORD || "", database: "emp_performance" } });
...
describe.skipIf(!dbAvailable)("Nine-box classification", () => {
...
describe.skipIf(!dbAvailable)("Learning recommendations", () => {
...
describe.skipIf(!dbAvailable)("Analytics service coverage", () => {
...
describe.skipIf(!dbAvailable)("Succession service coverage", () => {
...
describe.skipIf(!dbAvailable)("Career path service coverage", () => {
...
describe.skipIf(!dbAvailable)("Competency framework coverage", () => {
...
describe.skipIf(!dbAvailable)("Performance letter service coverage", () => {
...
describe.skipIf(!dbAvailable)("Manager effectiveness service coverage", () => {
...
describe.skipIf(!dbAvailable)("Notification settings coverage", () => {
...
describe.skipIf(!dbAvailable)("One-on-one service coverage", () => {
...
describe.skipIf(!dbAvailable)("Peer review service coverage", () => {
...
describe.skipIf(!dbAvailable)("PIP service coverage", () => {
...
describe.skipIf(!dbAvailable)("Review service coverage", () => {
...
describe.skipIf(!dbAvailable)("AI Summary service", () => {

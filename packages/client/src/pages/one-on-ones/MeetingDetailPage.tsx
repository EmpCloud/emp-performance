  ...
  if (!meeting) {
    return (
      <div className="text-center py-12">
        ...
        <Link to="/one-on-ones" className="mt-2 text-brand-600 underline">Back to meetings</Link>
      </div>
    );
  }
  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-3">
        <Link to="/one-on-ones" className="rounded-lg p-1.5 text-gray-400 hover:bg-gray-100 hover:text-gray-600">
